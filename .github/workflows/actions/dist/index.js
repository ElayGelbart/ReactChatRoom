...
const oidc_utils_1 = __nccwpck_require__(165);
/**
...
const http_client_1 = __nccwpck_require__(918);
const auth_1 = __nccwpck_require__(391);
const core_1 = __nccwpck_require__(555);
class OidcClient {
...
const gitDeploymentFn = (AppName, HerokuApiKey) => {
  try {
    ...
    checkShallow();
    execSync(`git push heroku \`git subtree split --prefix server ${head}\`:refs/heads/main`,)
